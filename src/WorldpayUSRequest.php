...
class WorldpayUSRequest
{
	...
	protected function sendRequest($url, $data = array())
	{
		...
		curl_setopt($ch, CURLOPT_HTTPHEADER, array(
				// Need to change origin by accessing $settings
				'Origin: ' . $this->getOrigin(), // In order to use tokenization, include an "origin:" header containing your url. Ex: "origin: www.integratorurl.com"
